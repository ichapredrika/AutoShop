...
public class phpConf {
    ...
    public final static String URL_GET_SERVICE_AUTOSHOP = prefix + "get_service_autoshop.php";
    ...
    public final static String URL_GET_TRANS_HISTORY = prefix + "get_trans_history.php";
    public final static String URL_REISSUE_TRANS = prefix + "reissue_trans.php";
